...
import { Camera, Disc2, FlipHorizontal,MoonIcon, SunIcon, Video, Volume2 } from 'lucide-react';
      ...
      <div className='flex flex-row flex-1'>
        <div className='border-primary/5 border-2 max-w-xs flex flex-col gap-2 justify-between shadow-md rounded-md p-4'>
          ...
          <Separator className='my-2' />
            ...
            >
              {autoRecordEnabled ? <Rings color='white' height={45} /> : <Disc2 />}
      ...
      <ul className="space-y-4">
        ...
        <li>
          ...
          <Button className='h-6 w-6 my-2'
            ...
            onClick={toggleAutoRecord}
          >
            {autoRecordEnabled ? <Rings color='white' height={30} /> : <Disc2 size={14} />}
